...
constexpr auto qt_meta_stringdata_CLASSLoginScreenENDCLASS = QtMocHelpers::stringData(
    "LoginScreen",
    "loginSuccess",
    "",
    "sessionID",
...
void LoginScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginScreen::loginSuccess; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginScreen::loginSuccess(const QString & _t1, const QString & _t2)
{
